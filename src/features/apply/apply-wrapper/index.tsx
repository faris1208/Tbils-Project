    ...
    <div className={styles.wrapper}>
      <div className={styles.container}>
        ...
        <div className={styles.best}>
          ...
          <p>
            Planning to visit, study, or work in Canada? Here&apos;s a complete
            guide to the visa requirements, necessary documents, and application
        ...
        <div className={styles.applying_canada}>
          ...
          <p>
            ...
            process, but with the right guidance, it&apos;s becomes much easier. At 
            <span> TBIL Travels,</span> we specialize in providing expert assistance to ensure
            your visa application is seamless and stress - free. Whether you are
            applying for a student visa, visitor visa, work permit, or permit
            residency, our team is here to guide you every step of the way.
          </p>

          <p>
            Beyond Canada, we also assist with <span>UK</span> and <span>US</span> visa applications,
            ensuring you have all the necessary documents and support for a
            successful outcome. Let TBIL Travels handle the details while you
            focus on your travel plans.
          </p>
          <p>
            Ready to start your visa applications? Contact us today and take the
            first step towards your international journey
          </p>
          <p>Click on the link below to begin your application process.</p>
          <div className={styles.btn}>
            <WhatsappIcon  className={styles.icon} />
            <div className={styles.contact}>
              <p>Canada Visa <span>Online</span></p>
