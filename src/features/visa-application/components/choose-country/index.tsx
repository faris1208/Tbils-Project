        ...
        <div className={styles.container_width}>
          <div className={styles.text}>
            ...
            <div className={styles.two}>
              <p>
                At Tibil Travels, we specialize in providing expert visa
                assistance to ensure your application meets required standards.
                Our knowlegeable team is dedicated to helping you undertsand the
                requirements, gather necessary documents, and submit a
